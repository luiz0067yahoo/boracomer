...
const routes = [
    ...
    {name: 'edit-item-pedido-store',                                        path: '/empresa/:aliasStore/item-pedido/:id/quantidade/:amount/obs/:note' , component:OrderItemComponent,},
    {name: 'edit-item-pedido-aditionais-store',                             path: '/empresa/:aliasStore/item-pedido/:id/adicionais/:idsItemsGroupsAdditional/quantidade/:amount/obs/:note' , component:OrderItemComponent,},
    {name: 'edit-item-pizza-pedido-store',                                  path: '/empresa/:aliasStore/item-pedido/:id/tamanho/:idSize/sabores/:idsFlavors/borda/:IdBorderSize/adicionais/:idsItemsGroupsAdditional/quantidade/:amount/obs/:note' , component:OrderItemComponent,},
    {name: 'edit-item-pizza-pedido-less-border-store',                      path: '/empresa/:aliasStore/item-pedido/:id/tamanho/:idSize/sabores/:idsFlavors/adicionais/:idsItemsGroupsAdditional/quantidade/:amount/obs/:note' , component:OrderItemComponent,},
    {name: 'edit-item-pizza-pedido-less-aditionais-store',                  path: '/empresa/:aliasStore/item-pedido/:id/tamanho/:idSize/sabores/:idsFlavors/borda/:IdBorderSize/quantidade/:amount/obs/:note' , component:OrderItemComponent,},
    {name: 'edit-item-pizza-pedido-less-aditionais-less-border-store',      path: '/empresa/:aliasStore/item-pedido/:id/tamanho/:idSize/sabores/:idsFlavors/quantidade/:amount/obs/:note' , component:OrderItemComponent,},
